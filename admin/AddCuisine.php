...
<body>
	...
	<h3>2. Add a Cuisine</h3>
		<div class="rest_form_group">
			...
			<input type="text" name="dish" class="form-control"value="<?php if(isset($_POST['dish'])) echo $_POST["dish"];	?>" >
		</div>
		<div class="rest_form_group">
			<label>Cuisine Type</label>
			<input type="text" name="type" class="form-control"value="<?php if(isset($_POST['type'])) echo $_POST["type"];	?>">
		</div>
		<div class="rest_form_group">
			<label>Cuisine Cost</label>
			<input type="integer" name="cost" class="form-control"value="<?php if(isset($_POST['cost'])) echo $_POST["cost"];	?>" >
		</div>
		<div class="rest_form_group">
			<label>Cuisine Details(if any)</label>
			<input type="integer" name="details" class="form-control"value="<?php if(isset($_POST['details'])) echo $_POST["details"];	?>" >
		</div>
