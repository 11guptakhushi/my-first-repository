		...
		<div class="card">
			...
			<form method="POST" action="AddRestaurant.php" enctype="multipart/form-data">
				<div class="rest_form_group">
					...
					<input type="text" name="restaurantname" value="<?php echo $_POST['restaurantname'];	?>" required>	
				</div><br />
				<div class="rest_form_group">
					<label>Owner Name</label>
					<input type="text" name="owner" value="<?php echo $_POST['owner'];	?>" required>	
				</div><br />
				<div class="rest_form_group">
					<label>Address</label>
				...
				<div class="form-group">
					<label>City</label>
					<input type="text" name="city" value="<?php echo $_POST['city'];	?>" required>	
				</div>
				<div class="form-group">
					<label>Cost for One Person</label>
					<input type="integer" name="cost_one" value="<?php echo $_POST['cost_one'];	?>" required>	
				</div>
				<div class="form-group">
					<label>Delivery Time</label>
					<input type="integer" name="delivery_time" value="<?php echo $_POST['delivery_time'];	?>"required>	
				</div>
				<div class="form-group">
					<label>Minimum Order</label>
					<input type="integer" name="min_order" value="<?php echo $_POST['min_order'];	?>"required>	
				</div>
				<div class="rest_form_group">
				...
				<div class="form-group">
					<label>Ranking</label>
					<input type="integer" name="ranking" value="<?php echo $_POST['ranking'];	?>"required>	
				</div>							
