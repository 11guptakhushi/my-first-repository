		...
		<td>	  
		  <div class="contact_form">
			...
			<form id="contactform" action="" method="post" role="form" class="contactForm">
			  ...
			  <div class="field">
				  <input type="text" name="name" value="<?php echo $_POST['name'];	?>" placeholder="* Enter your full name" minlen="4" required/>
				  <input type="text" name="email" value="<?php echo $_POST['email'];	?>" placeholder="* Enter your email address" required/>
				  <input type="text" name="subject" value="<?php echo $_POST['subject'];	?>" placeholder="Enter your subject" minlen="4"/>
				  <textarea rows="12" name="message" value="<?php echo $_POST['message'];	?>" placeholder="* Your message here..." required></textarea>
				  <p>
