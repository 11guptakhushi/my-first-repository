...
<?php	include("includes/head.php");	?>
	<div class="card" id='pay_detail' style="margin:20px 50px;">
		...
		<div class="card_in" style="display:block;">
			...
			<form method="post">
				<div class="inputbox">
					<input type="text" name="card_no" value="<?php if(isset($_POST['card_no'])) echo $_POST['card_no'];?>" required />
					<label>Debit Card Number</label>
				</div>
				<label style="color:gray; font-weight:bold;">Select Expiry Date</label>
				<div class="inputbox">
					<input type="month" name="date" value="<?php if(isset($_POST['date'])) echo $_POST['date'];?>" required />
				</div>
				<div class="inputbox">
					<input type="password" name="cvv" value="<?php if(isset($_POST['cvv'])) echo $_POST['cvv'];?>" required />
					<label>CVV</label>
				</div>
				<div class="inputbox">
