...
<section>
	<div class ="registerbox">
		...
		<form method="post">
			<div class ="inputbox">
				<input type="text" name="f_name" value="<?php echo $_POST['f_name'];?>" required/>
				<label>First Name</label>
			</div>

			<div class ="inputbox">
				<input type="text" name="l_name" value="<?php echo $_POST['l_name'];?>"  required />
			...
			<div class="inputbox">
				<input type="password" name="password" value="<?php echo $_POST['password'];?>" minlength="8" required  />
				<label>Password</label>
			</div>

			<div class="inputbox">
				<input type="password" name="confirm" value="<?php echo $_POST['confirm'];?>"  required />
